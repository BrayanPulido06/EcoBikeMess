                                    ...
                                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                                        <label class="radio-card">
                                            ...
                                            <div class="radio-card-content">
                                                <strong>SÍ, AGREGAR AL RECAUDO</strong>
                                        ...
                                        <label class="radio-card">
                                            ...
                                            <div class="radio-card-content">
                                                <strong>NO AGREGAR AL RECAUDO</strong>
                                                <small>no cobrar el envio al destinatario</small>
                                            </div>
                                        </label>
                                    </div>
                                    <div id="preview_total_recaudo" style="margin-top: 15px; font-weight: bold; color: #155724; background-color: #d4edda; border-color: #c3e6cb; padding: 12px; border-radius: 6px; text-align: center; font-size: 25px; display: none;"></div>
                                    <span class="error-message"></span>
                                </div>
                                            ...
                                            <td colspan="2">
                                                <div style="display: flex; align-items: center; gap: 100px; justify-content: center; text-align: center;">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div style="margin-top: 3px; font-size: 15px; font-weight: 700; color: #28a745;">Contactanos: 3123180619</div>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
