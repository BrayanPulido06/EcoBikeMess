...
// Incluir conexiÃƒÂ³n y obtener direcciÃƒÂ³n principal del cliente
...
try {
    ...
    if ($conn) {
        if (isset($_SESSION['user_role']) && $_SESSION['user_role'] === 'colaborador') {
            // Si es colaborador, obtenemos la direcciÃƒÂ³n de la tienda (cliente) y el telÃƒÂ©fono del colaborador
...
<head>
    ...
    <style>
        ...
        /* RÃƒÂ³tulo 10x10 cm (igual a paquetesAdmin) */
        #rotuloPreview {
            width: 100mm;
            height: 100mm;
        ...
        /* Asegurar que el QR del rÃƒÂ³tulo no se encoja por estilos globales */
        ...
        /* Estilos para tarjetas de selecciÃƒÂ³n de recaudo */
        .radio-card {
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="content-container" id="mainEnvioContainer">
            <!-- Mensajes de ValidaciÃƒÂ³n y Feedback -->
            ...
            <?php if (isset($_GET['msg']) && $_GET['msg'] === 'envio_creado'): ?>
                <div style="background-color: #e8f5e9; color: #2e7d32; padding: 15px; border-radius: 4px; margin-bottom: 20px; border: 1px solid #a5d6a7; margin-top: 100px;">
                    <strong>Ã‚Â¡Ãƒâ€°xito!</strong> Su envÃƒÂ­o ha sido registrado correctamente.
                    <?php if(isset($_GET['guia'])): ?>
                        <br>NÃƒÂºmero de GuÃƒÂ­a: <strong><?php echo htmlspecialchars($_GET['guia']); ?></strong>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
            ...
            <div class="page-header">
                <div class="header-left">
                    <h1>Crear Nuevo EnvÃƒÂ­o</h1>
                    <p>Complete la informaciÃƒÂ³n para generar su guÃƒÂ­a de envÃƒÂ­o</p>
                </div>
            </div>
            ...
            <form id="envioForm" class="envio-form" action="../../controller/enviarPaqueteController.php" method="POST" novalidate>
                ...
                <div class="form-step active" data-step="1">
                    <div class="card">
                        <div class="card-header">
                            <h2>Ã°Å¸â€œÂ¤ Datos del Remitente</h2>
                        ...
                        <div class="card-body">
                            <div class="form-row">
                                ...
                                <div class="form-group">
                                    <label for="remitente_telefono">TelÃƒÂ©fono *</label>
                            ...
                            <div class="form-group">
                                <label for="remitente_direccion">DirecciÃƒÂ³n de Origen Completa *</label>
                ...
                <div class="form-step" data-step="2">
                    <div class="card">
                        <div class="card-header">
                            <h2>Ã°Å¸â€œÂ¥ Datos del Destinatario</h2>
                        </div>
                        <div class="card-body">
                            <div class="form-row">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="destinatario_telefono">TelÃƒÂ©fono *</label>
                            ...
                            <div class="form-group">
                                <label for="destinatario_direccion">DirecciÃƒÂ³n de Destino Completa *</label>
                            ...
                            <div class="form-group">
                                <label for="instrucciones_entrega">Observaciones y/o DescripciÃƒÂ³nes</label>
                                <textarea id="instrucciones_entrega" name="instrucciones_entrega" rows="3" placeholder="Ej: Tocar el timbre 2 veces, entregar en porterÃƒÂ­a, etc."></textarea>
                            </div>
                            <div class="form-group">
                                <label class="checkbox-label">
                                    <input type="checkbox" id="tiene_recaudo" name="tiene_recaudo">
                                    <span>Este envÃƒÂ­o tiene recaudo (pago contra entrega)</span>
                                </label>
                            </div>
                ...
                <div class="form-step" data-step="3">
                    <div class="card">
                        <div class="card-header">
                            <h2>Ã°Å¸â€œÂ¦ InformaciÃƒÂ³n del Paquete</h2>
                        </div>
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <select id="dimensiones_paquete" name="dimensiones_paquete" required>
                                    <option value="">Seleccionar tamaÃƒÂ±o...</option>
                            ...
                            <div class="form-row" style="margin-top: 15px;">
                                <div class="form-group">
                                    <label class="checkbox-label">
                                        ...
                                        <span>Ã‚Â¿Entrega el mismo dÃƒÂ­a? (+$2.000)</span>
                                    </label>
                                </div>
                                <div class="form-group">
                                    <label class="checkbox-label">
                                        <input type="checkbox" id="zona_periferica" name="zona_periferica">
                                        <span>Destino Soacha, Usme, C. BolÃƒÂ­var o San CristÃƒÂ³bal sur (+$4.000)</span>
                                    </label>
                                </div>
                                <div class="form-group">
                                    <label class="checkbox-label">
                                        <input type="checkbox" id="recoger_cambios" name="recoger_cambios">
                                        <span>Ã‚Â¿Hay cambios por recoger? (+$5.000)</span>
                                    </label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card cost-card">
                        <div class="card-header">
                            <h2>Ã°Å¸â€™Â° CÃƒÂ¡lculo del Costo</h2>
                        </div>
                        <div class="card-body">
                            <div class="cost-breakdown">
                                ...
                                <div class="cost-item">
                                    <span>Entrega mismo dÃƒÂ­a:</span>
                                    <span id="recargoMismoDia">$0</span>
                                </div>
                                <div class="cost-item">
                                    <span>Zonas de difÃƒÂ­cil acceso:</span>
                                ...
                                <!-- OpciÃƒÂ³n para sumar envÃƒÂ­o al recaudo -->
                                <div class="form-group" id="container_sumar_envio" style="display: none; margin-top: 25px; border-top: 2px dashed #eee; padding-top: 20px;">
                                    <label style="font-weight: bold; display: block; margin-bottom: 15px; font-size: 1.1rem; color: #2c3e50;">Ã‚Â¿Desea sumar el costo del envÃƒÂ­o al valor del recaudo? *</label>
                                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                                        <label class="radio-card">
                                            <input type="radio" name="envio_destinatario" value="si" required>
                                            <div class="radio-card-content">
                                                <strong>SÃƒÂ, SUMAR</strong>
                                                <small>Cobrar envÃƒÂ­o al destinatario</small>
                                            </div>
                                        </label>
                                        <label class="radio-card">
                                ...
                                <!-- Campo oculto para enviar el nÃƒÂºmero de guÃƒÂ­a generado en JS -->
                            ...
                            <button type="button" class="btn-text" id="calcularCosto" style="display: none;">
                                Ã°Å¸â€â€ž Calcular costo
                            </button>
                        </div>
                    </div>
                </div>

                <!-- PASO 4: CONFIRMACIÃƒâ€œN -->
                <div class="form-step" data-step="4">
                    <div class="card confirmation-card">
                        <div class="card-header">
                            <h2>Ã¢Å“â€œ Confirmar EnvÃƒÂ­o</h2>
                        </div>
                        <div class="card-body">
                                    ...
                                    <table style="width: 100%; border-bottom: 2px solid #5cb85c; padding-bottom: 6px;">
                                        ...
                                        <tr>
                                            <td colspan="2" style="padding-top: 4px;">
                                                <div style="font-size: 13px; font-weight: 800; color: #000000;">NUM GUÃƒÂA: <span id="numeroGuia" style="font-size: 19px; font-weight: 800; color: #1f2a37;">EBM-2024-XXXXX</span></div>
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <table style="width: 100%; margin-top: 4px; font-size: 12px;">
                                        <tr>
                                            <td class="rotulo-card" style="width: 48%; vertical-align: top; border: 1px solid #eee; padding: 6px; border-radius: 8px;">
                                                ...
                                                <p><strong>DirecciÃƒÂ³n:</strong> <span id="confirm_destinatario_direccion" class="rotulo-text-lg bold"></span></p>
                                                <p><strong>Nombre:</strong> <span id="confirm_destinatario_nombre" class="rotulo-text-lg bold"></span></p>
                                                <p><strong>TelÃƒÂ©fono:</strong> <span id="confirm_destinatario_telefono" class="rotulo-text-lg bold"></span></p>
    ...
    <div id="bulkPreviewContainer" class="content-container bulk-preview-container" style="display: none;">
        <div class="card">
            <div class="card-header">
                <h2>Ã°Å¸â€œÂ¦ Carga Masiva de EnvÃƒÂ­os</h2>
                <div class="header-actions">
                    <button type="button" class="btn-text" id="btnCancelBulk" style="color: #dc3545;">Ã¢ÂÅ’ Cancelar</button>
                    <button type="button" class="btn-primary" id="btnProcessBulk">Ã°Å¸Å¡â‚¬ Procesar Todos</button>
                </div>
            </div>
            <div class="card-body">
                <p class="bulk-summary">Se han detectado mÃƒÂºltiples envÃƒÂ­os. Revisa la informaciÃƒÂ³n cargada antes de procesar.</p>
    ...
    <!-- Modal WhatsApp (Agregado dinÃƒÂ¡micamente) -->
    <div id="whatsappModal" class="modal" style="display: none; position: fixed; z-index: 9999; left: 0; top: 0; width: 100%; height: 100%; background-color: rgba(0,0,0,0.5); justify-content: center; align-items: center;">
        <div class="modal-content" style="background: white; padding: 30px; border-radius: 15px; text-align: center; max-width: 400px; position: relative; box-shadow: 0 5px 15px rgba(0,0,0,0.3); animation: fadeIn 0.3s;">
            ...
            <div style="font-size: 50px; margin-bottom: 15px;">Ã°Å¸â€œÂ¦</div>
            <h3 style="margin-bottom: 15px; color: #333;">Dimensiones Especiales</h3>
            <p style="margin-bottom: 25px; color: #666;">Para paquetes de 50x50 cm o mÃƒÂ¡s, por favor contÃƒÂ¡ctanos directamente para coordinar el envÃƒÂ­o.</p>
    ...
    <!-- LibrerÃƒÂ­as para QR con logo y para generar PDF -->
