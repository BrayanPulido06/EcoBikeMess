DROP DATABASE IF EXISTS u478643953_ecobikemess;
CREATE DATABASE IF NOT EXISTS u478643953_ecobikemess;
USE u478643953_ecobikemess;
...
CREATE TABLE IF NOT EXISTS facturacion_adicionales_cliente (
    ...
    descripcion_positiva TEXT,
    monto_negativo DECIMAL(10,2) NOT NULL DEFAULT 0.00,
    descripcion_negativa TEXT,
    registrado_por INT NULL,
    fecha_registro TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    fecha_actualizacion TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS facturacion_estados_mensajero (
    id INT PRIMARY KEY AUTO_INCREMENT,
    mensajero_id INT NOT NULL,
    fecha_grupo DATE NOT NULL,
    estado ENUM('pendiente', 'pagado') NOT NULL DEFAULT 'pendiente',
